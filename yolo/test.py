...
@torch.no_grad()
def run(weights='./runs/train/exp/weights/best.pt',  # model.pt path(s)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # NMS
        #print(conf_thres = 0.5, iou_thres = 0.45, classes=None, agnostic_nms = False, max_det = 2)
...
#     run(**vars(opt))
# python detect.py  --weights runs/train/exp/weights/best.pt --source file.png  # image
