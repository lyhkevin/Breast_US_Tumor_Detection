...
origin_file = '/public/home/liyh2022/projects/breast_data_preprocessing/benign/processed/US/tumor/'
save_file = '/public/home/liyh2022/projects/breast_data_preprocessing/benign/processed/US/final/'
...
for i in range(len(patient)):
    ...
    img = glob(patient_path + '/crop/*.png', recursive=True)
    ...
    if len(img) > 1:
        ...
        print(patient[i], '  ', idx_img2[max_idx], idx_img1[max_idx])
